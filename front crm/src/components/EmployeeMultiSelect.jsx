        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-2">
            ...
            >
              ...
              <option value="Development" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Development</option>
              <option value="Designing" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Designing</option>
              <option value="Marketing" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Marketing</option>
              <option value="HR & Admin" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">HR & Admin</option>
            ...
            >
              ...
              <option value="Full Stack Developer" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Full Stack Developer</option>
              <option value="Frontend Developer" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Frontend Developer</option>
              <option value="Backend Developer" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Backend Developer</option>
              <option value="UI/UX Designer" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">UI/UX Designer</option>
              <option value="Project Manager" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Project Manager</option>
              <option value="QA Lead" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">QA Engineer</option>
            </select>
            ...
            >
              ...
              <option value="Manager" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Manager / Lead</option>
              <option value="Developer" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Developer</option>
              <option value="Designer" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Designer</option>
              <option value="Staff" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">Staff</option>
            </select>
          </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[10px] font-mono text-indigo-700 dark:text-indigo-300 font-bold bg-indigo-100/80 dark:bg-indigo-950 px-1.5 py-0.5 rounded-md border border-indigo-200 dark:border-indigo-800">
                            #{emp.employeeId || 'EMP'}
                          </span>
                        </div>

                        <div className="flex items-center gap-2 text-[10px] text-slate-500 dark:text-slate-400 font-semibold mt-0.5">
                          <span className="font-bold text-slate-700 dark:text-slate-300">{emp.designation || emp.role || 'Staff'}</span>
                          <span>•</span>
