                      ...
                      <tr key={id} className="hover:bg-indigo-50/40 dark:hover:bg-slate-800/50 transition-colors">
                        ...
                        <td className="p-4 text-center">
                          <div className="flex items-center justify-center gap-1.5">
                            <Link
                              to={`/projects/${id}/visible-work`}
                              title="Work Visible"
                              className="px-2.5 py-1.5 rounded-lg bg-indigo-50 dark:bg-indigo-950/40 text-indigo-600 hover:bg-indigo-600 hover:text-white text-[11px] font-bold transition-all"
                            >
                              Work Visible
                            </Link>
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-400 hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/40 transition-colors"
                            >
              ...
              >
                ...
                <div className="mt-4 pt-3 flex items-center justify-between gap-2 border-t border-slate-100 dark:border-slate-800/60">
                  <div className="flex items-center gap-1.5">
                    <Link
                      to={`/projects/${id}/visible-work`}
                      className="px-2.5 py-1.5 rounded-xl bg-indigo-50 dark:bg-indigo-950/40 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-600 hover:text-white text-xs font-bold transition-all"
                    >
                      Work Visible
                    </Link>
