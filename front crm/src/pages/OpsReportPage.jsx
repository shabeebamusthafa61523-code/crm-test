  ...
  const handleDownloadWeeklyPDF = async (weeklyData) => {
    try {
      ...
      try {
        ...
        showToast("Weekly PDF saved to database successfully!", "success");
      } catch (uploadErr) {
        console.error("Failed to upload weekly PDF:", uploadErr);
        showToast(`Failed to save weekly report to database: ${uploadErr.message || uploadErr}`, "error");
      }
      doc.save(filename);
  ...
  const handleDownloadMonthlyPDF = async (monthlyData) => {
    try {
      ...
      try {
        ...
        showToast(`Failed to save monthly report to database: ${uploadErr.message || uploadErr}`, "error");
      }
      doc.save(filename);
